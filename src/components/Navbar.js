  ...
  return (
    <nav className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <ul
          className={`md:flex space-x-6 absolute md:static bg-white w-full md:w-auto transition-transform duration-300 ease-in-out ${isOpen ? 'top-16' : '-top-96'} md:top-0`}
        >
          <li className="relative group">
            ...
            <span className="absolute left-0 right-0 bottom-[-4px] h-0.5 bg-black scale-x-0 transition-transform duration-500 group-hover:scale-x-100" />
          </li>
