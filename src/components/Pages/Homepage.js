...
const scrollToTop = () => {
  ...
  return (
    ...
    />
    {/* Hero — banner from public/ (same path as production on Netlify/static hosts) */}
    <section
      className="homepage-section"
      aria-label="AeroEdge hero banner"
      style={{
        backgroundImage: `url(${process.env.PUBLIC_URL}/images/homepage-banner.png)`,
      }}
    >
      <div className="homepage-section__inner flex justify-start items-center h-full ml-6 md:ml-10">
        <div className="homepage-hero-copy text-left">
          <p className="homepage-hero-tagline">defence &amp; industrial</p>
        </div>
      </div>
    </section>
      {/* Services Section */}
